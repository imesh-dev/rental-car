...
{ ?>
          <ul>
            <li>
              ...
              <div class="contact_info_m">Address :Trendy Car Rents, Colombo, Sri Lanka.</div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m">tel:+94-123567890</a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m">trendycarrent@example.com</a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
